...
<html>
    <head>
        ...
        <meta charset="utf-8">
            ...
            <link rel="stylesheet" href="MODUL4_FAIZAL/Login-Faizal.css">
    </head>
    <?php 
        if (isset($_SESSION['registrasi'])) : ?>
        <div class="alert alert-success alert-dismissable fade show fade in" role="alert" style="position: absolute;">
    ...
    <?php 
        ...
        <div class="alert alert-warning m-0 p-2 alert-dismissible" role="alert" style="position: absolute;">
        ...
        <div class="row">
            ...
            <div class="column">
                ...
                <br>
                    ...
                    <input type="email" name="email" id="femail" value="<?php if(isset($_COOKIE["username"])) { echo $_COOKIE["username"]; } ?>" required><br>
